...
This is a Flutter-based application that leverages Firebase for robust and secure user authentication. The application allows for user registration, login with email and password, as well as provides the ability to sign in with Google and sign out.
...
- **Sign in with Google:** Users have the option to sign in using their Google account. The application integrates with Google Sign-In and utilizes Firebase's `signInWithCredential` method.
...
## Screenshots
<p float="left">
  <img src="Simulator Screen Shot - iPhone 14 Pro - 2023-05-30 at 13.08.34.png" width="200">
  <img src="Simulator Screen Shot - iPhone 14 Pro - 2023-05-30 at 13.08.23.png" width="200">
  <img src="Simulator Screen Shot - iPhone 14 Pro - 2023-05-30 at 13.08.20.png" width="200">
